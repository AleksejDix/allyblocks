...
export const useMyComponent = createActionHook<MyComponentContext>(MyComponentContext, 'useMyComponent')
```
...
export function MyComponentButton({ action, onAction, value, context, ...props }) {
