...
export const DataGridContext = createContext<DataGridContextType<RowData> | null>(null)

export const useDataGrid = () => {
  const context = useContext(DataGridContext)
  if (!context) {
    throw new Error('useDataGrid must be used within a DataGridContextProvider')
  }
  return context
}
