  ...
  render: (args) => (
    <Accordion {...args}>
      <AccordionItem value="item-1">
        ...
        <AccordionBody>Yes. It adheres to the WAI-ARIA design pattern.</AccordionBody>
      </AccordionItem>
      <AccordionItem value="item-2">
        ...
        <AccordionBody>Yes. It comes with default styles that match the other components' aesthetic.</AccordionBody>
      </AccordionItem>
      <AccordionItem value="item-3">
        ...
        <AccordionBody>Yes. It's animated by default, but you can disable it if you prefer.</AccordionBody>
      </AccordionItem>
    </Accordion>
  ),
  ...
  render: (args) => (
    <Accordion {...args}>
      <AccordionItem value="item-1">
        ...
        <AccordionBody>This example uses a plus icon that rotates to create a visual effect when open.</AccordionBody>
      </AccordionItem>
    </Accordion>
  ),
}
    ...
    return (
      <div className="space-y-4">
        <div className="flex gap-2">
          <Button onClick={() => setValue('item-1')} variant={value === 'item-1' ? 'default' : 'outline'}>
            Show Item 1
          </Button>
          <Button onClick={() => setValue('item-2')} variant={value === 'item-2' ? 'default' : 'outline'}>
            Show Item 2
          </Button>
          <Button onClick={() => setValue('item-3')} variant={value === 'item-3' ? 'default' : 'outline'}>
            Show Item 3
          </Button>
          <Button onClick={() => setValue('')} variant={value === '' ? 'default' : 'outline'}>
            Close All
          </Button>
        </div>
        ...
        <Accordion type="single" collapsible value={value} onValueChange={setValue}>
          <AccordionItem value="item-1">
            ...
            <AccordionBody>This accordion item is externally controlled.</AccordionBody>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionHeader>
              <AccordionTrigger>
            ...
            <AccordionBody>Click the buttons above to control which item is open.</AccordionBody>
          </AccordionItem>
          <AccordionItem value="item-3">
            <AccordionHeader>
              <AccordionTrigger>
            ...
            <AccordionBody>The state is managed outside the Accordion component.</AccordionBody>
          </AccordionItem>
        </Accordion>
      </div>
    )
  ...
  render: (args) => (
    <Accordion {...args}>
      <AccordionItem value="item-1">
        ...
        <AccordionBody>
          This example uses separate indicator components for open and closed states, giving you precise control over
