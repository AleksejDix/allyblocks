...
const meta = {
  ...
  argTypes: {
    ...
    onSubmit: {
      description: 'Callback function called when the form is submitted successfully',
    },
    onError: {
      description: 'Callback function called when an error occurs during submission',
    },
    defaultValues: {
