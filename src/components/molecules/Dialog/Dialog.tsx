...
function DialogClose({ onAction, value, context, ...props }: DialogCloseProps) {
  ...
  return <DialogPrimitive.Close data-slot="dialog-close" onClick={handleClick} value="close" {...props} />
}
...
function DialogBody({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="dialog-body" className={cn('p-4 overflow-scroll max-h-[100dvh]', className)} {...props} />
}
...
function DialogHeader({ className, ...props }: DialogHeaderProps) {
  return <div data-slot="dialog-header" className={cn('text-left p-4', className)} {...props} />
}
...
function DialogTitle({ className, ...props }: DialogTitleProps) {
  return <DialogPrimitive.Title data-slot="dialog-title" className={cn('text-left', className)} {...props} />
}
