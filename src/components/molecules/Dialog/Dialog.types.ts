...
export type DialogTriggerProps = DialogProps & ComponentPropsWithoutRef<typeof DialogPrimitive.Trigger>

export type DialogContentProps = DialogProps &
  Omit<ComponentPropsWithoutRef<typeof DialogPrimitive.Content>, 'onAnimationEnd'>

export type DialogCloseProps = ComponentPropsWithoutRef<typeof DialogPrimitive.Close> & ActionTriggerProps<DialogAction>
