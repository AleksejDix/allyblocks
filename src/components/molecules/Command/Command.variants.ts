...
export const commandVariants = cva(
  ['bg-popover', 'text-popover-foreground', 'flex', 'flex-col', 'overflow-hidden', 'outline-none'],
  {
    variants: {
      size: {
        default: ['w-full'],
...
export const commandInputWrapperVariants = cva(['flex', 'items-center', 'px-3', 'py-2', 'border-b', 'border-border'], {
  variants: {
    size: {
      default: ['h-9'],
      sm: ['h-9'],
...
export const commandSeparatorVariants = cva(['bg-border', '-mx-1', 'h-px', 'my-1'])
