...
export const WithDisabledItems: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Dropdown menu with some disabled items that cannot be selected.',
      },
    },
  },
  play: async ({ canvasElement }) => {
...
export const ControlledDropdown: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates controlled open state using the open and onOpenChange props.',
      },
    },
  },
  play: async ({ canvasElement }) => {
...
export const NonModalDropdown: Story = {
  render: () => (
    <div className="flex items-center justify-center p-10">
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent>
          <DropdownMenuItem>Clicking outside won't close this menu</DropdownMenuItem>
          <DropdownMenuItem>Unless you click the trigger again</DropdownMenuItem>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Non-modal dropdown menu that allows interactions outside without closing. Using modal={false}.',
      },
    },
  },
  play: async ({ canvasElement }) => {
...
export const WithCustomAlignment: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Shows different alignment options with align, alignOffset, side, and sideOffset props.',
      },
    },
  },
  play: async ({ canvasElement }) => {
...
export const WithCollisionHandling: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates collision handling with collisionPadding and avoidCollisions props.',
      },
    },
  },
  play: async ({ canvasElement }) => {
