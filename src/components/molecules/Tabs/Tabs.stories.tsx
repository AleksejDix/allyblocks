    ...
    <Tabs {...args}>
      ...
      <TabsContent value="overview">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">This tab is available and shows the main dashboard overview.</p>
        </div>
      </TabsContent>
      <TabsContent value="analytics">
        <div className="space-y-4">
          <h3 className="text-lg font-medium">Analytics (Disabled)</h3>
          <p className="text-muted-foreground">This content won't be accessible due to disabled tab.</p>
        </div>
      </TabsContent>
      <TabsContent value="reports">
        <div className="space-y-4">
          <h3 className="text-lg font-medium">Reports</h3>
          <p className="text-muted-foreground">This tab is available and shows reports functionality.</p>
        </div>
      </TabsContent>
      <TabsContent value="settings">
        <div className="space-y-4">
          <h3 className="text-lg font-medium">Settings (Disabled)</h3>
          <p className="text-muted-foreground">This content won't be accessible due to disabled tab.</p>
        </div>
      </TabsContent>
      <TabsContent value="billing">
        <div className="space-y-4">
          <h3 className="text-lg font-medium">Billing (Disabled)</h3>
          <p className="text-muted-foreground">This content won't be accessible due to disabled tab.</p>
        </div>
      </TabsContent>
    </Tabs>
