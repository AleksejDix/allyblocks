...
export const WithChildren: Story = {
  render: () => (
    <Prose>
      <h1>Heading 1</h1>
      <p>
        This is a paragraph with some text. It includes <strong>bold text</strong>, <em>italic text</em>, and{' '}
        <a href="#">a link</a>.
      </p>
      <h2>Heading 2</h2>
      <p>
        Another paragraph with some more text. This one includes <code>inline code</code> and a <a href="#">link</a>.
      </p>
      <h3>Heading 3</h3>
      <ul>
        <li>List item 1</li>
