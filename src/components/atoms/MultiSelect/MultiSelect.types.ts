...
export interface MultiSelectLabelProps extends React.HTMLAttributes<HTMLDivElement> {
  /** Children elements */
  children: React.ReactNode;
}

export interface MultiSelectSeparatorProps extends React.HTMLAttributes<HTMLDivElement> {
  /** Additional CSS classes */
  className?: string;
}
