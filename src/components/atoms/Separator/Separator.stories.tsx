...
export const Styled: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Separator with custom styling applied through the className prop.',
      },
    },
  },
}
...
export const Polymorphic: Story = {
  ...
  render: (args) => (
    <div className="space-y-4">
      <div>Content above</div>
      <Separator {...args}>
        <hr className="border-t-2 border-dashed border-primary my-4" aria-label="Section divider" />
      </Separator>
      <div>Content below</div>
    </div>
  ),
